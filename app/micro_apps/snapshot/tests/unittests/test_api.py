...
@mock.patch.object(service, "get_user_id_from_token", MockService.get_user_id_from_token)
@mock.patch.object(service, "get_root_id_from_api", MockService.get_root_id_from_api)
@mock.patch.object(service, "get_all_shared_drives_from_api", MockService.get_all_shared_drives_from_api)
@mock.patch.object(service, "get_all_files_from_api", MockService.get_all_files_from_api)
@mock.patch.object(service, "create_file_snapshot", MockService.create_file_snapshot)
@mock.patch.object(service, "perform_inherit_direct_permission_analysis",
...
@mock.patch.object(AuthJWT, "get_jwt_subject", MockAuthJWT.get_jwt_subject)
@mock.patch.object(service, "get_user_id_from_token", MockService.get_user_id_from_token)
@mock.patch.object(service, "edit_file_snapshot_name", MockService.edit_file_snapshot_name)
...
@mock.patch.object(AuthJWT, "get_jwt_subject", MockAuthJWT.get_jwt_subject)
@mock.patch.object(service, "get_user_id_from_token", MockService.get_user_id_from_token)
@mock.patch.object(service, "get_file_snapshot_names", MockService.get_file_snapshot_names)
...
@mock.patch.object(service, "get_permission_of_files", MockService.get_permission_of_files)
...
@mock.patch.object(AuthJWT, "get_jwt_subject", MockAuthJWT.get_jwt_subject)
@mock.patch.object(service, "get_user_id_from_token", MockService.get_user_id_from_token)
@mock.patch.object(service, "get_files_of_shared_with_me", MockService.get_files_of_shared_with_me)
@mock.patch.object(service, "get_permission_of_files", MockService.get_permission_of_files)
...
@mock.patch.object(AuthJWT, "get_jwt_subject", MockAuthJWT.get_jwt_subject)
@mock.patch.object(service, "get_user_id_from_token", MockService.get_user_id_from_token)
@mock.patch.object(service, "get_files_of_shared_drive", MockService.get_files_of_shared_drive)
@mock.patch.object(service, "get_permission_of_files", MockService.get_permission_of_files)
...
@mock.patch.object(AuthJWT, "get_jwt_subject", MockAuthJWT.get_jwt_subject)
@mock.patch.object(service, "get_user_id_from_token", MockService.get_user_id_from_token)
@mock.patch.object(service, "get_file_folder_sharing_difference", MockService.get_file_folder_sharing_difference)
@mock.patch.object(service, "get_permission_of_files", MockService.get_permission_of_files)
def test_valid_file_folder_sharing_difference():
    params = {
        "snapshot_name": "MOCK_FILE_SNAPSHOT1",
        "file_id": "MOCK_FILE_ID1"
    }
    response = client.get("/apps/snapshot/v1/google/files/differences/sharing", params=params)
    assert response.status_code == 200
...
@mock.patch.object(AuthJWT, "get_jwt_subject", MockAuthJWT.get_jwt_subject)
@mock.patch.object(service, "get_user_id_from_token", MockService.get_user_id_from_token)
@mock.patch.object(service, "get_difference_of_two_snapshots", MockService.get_difference_of_two_snapshots)
...
@mock.patch.object(AuthJWT, "get_jwt_subject", MockAuthJWT.get_jwt_subject)
@mock.patch.object(service, "get_user_id_from_token", MockService.get_user_id_from_token)
@mock.patch.object(service, "scratch_group_memberships_from_file", MockService.scratch_group_memberships_from_file)
...
def test_valid_create_group_membership_snapshot():
    with open(absolute_path_to_data + "/member_list.html") as file:
        ...
        response = client.post("/apps/snapshot/v1/google/groups", data=body,
...
@mock.patch.object(AuthJWT, "get_jwt_subject", MockAuthJWT.get_jwt_subject)
@mock.patch.object(service, "get_user_id_from_token", MockService.get_user_id_from_token)
@mock.patch.object(service, "get_recent_group_membership_snapshots", MockService.get_recent_group_membership_snapshots)
...
@mock.patch.object(AuthJWT, "get_jwt_subject", MockAuthJWT.get_jwt_subject)
@mock.patch.object(service, "get_user_id_from_token", MockService.get_user_id_from_token)
@mock.patch.object(service, "get_recent_group_membership_snapshots", MockService.get_none)
