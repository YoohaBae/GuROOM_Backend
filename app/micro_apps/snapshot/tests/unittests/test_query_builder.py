...
@mock.patch.object(QueryBuilder, "__init__", new_init)
def test_create_tree_from_query():
    ...
    mock_query_builder = QueryBuilder(mock_user_id, mock_user_email, mock_snapshot_name)
